...
export default function ProfileEdit() {
  ...
  return (
    <div className="vp-page-shell vp-page-shell-narrow min-h-[calc(100vh-4rem)]">
      ...
      <form onSubmit={handleSubmit} className="space-y-4 font-body">
        ...
        {/* Change email */}
        <div className="border border-line rounded-xl p-4 vp-surface-soft">
        ...
        <div>
          ...
          <div className="mt-2 space-y-3">
            {(form.clubs || []).map((club, i) => (
              <div key={i} className="border border-line rounded-lg p-3 space-y-2 vp-surface-soft">

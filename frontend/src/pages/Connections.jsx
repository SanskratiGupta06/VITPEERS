...
export default function Connections() {
  ...
  return (
    <div className="vp-page-shell vp-page-shell-narrow vp-connections-shell min-h-[calc(100vh-4rem)]">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-10 sm:py-14 font-body"><div className="vp-page-heading"><span className="section-kicker">NETWORK / CONNECTIONS</span><p className="vp-page-code">LINKS ONLINE</p></div>
      <h1 className="font-display text-4xl sm:text-5xl text-navy mb-8">Your connections</h1>

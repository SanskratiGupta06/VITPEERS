...
function Landing() {
  ...
  const trustPoints = [
    [ShieldCheck, "Safe & Secure", "Your data stays protected with modern authentication"],
    [Users, "VIT Exclusive", "Only for VIT students, verified by your college email"],
    [Zap, "Real Connections", "Build relationships that actually last beyond a chat"],
    [Trophy, "Opportunities", "Discover collaborators, guidance and career openings"],
  ];
  ...
  return (
    <main>
      <section className="vp-hero">
        <div className="vp-hero-grid max-w-7xl mx-auto px-5 sm:px-8 pt-12 sm:pt-20 lg:pt-24 pb-20 sm:pb-24 grid lg:grid-cols-[1.02fr_.98fr] gap-12 items-center">
          ...
          <div className="relative min-h-[430px] sm:min-h-[500px] flex items-center justify-center reveal" style={{ animationDelay: "120ms" }}>
            <div className="absolute w-[360px] h-[360px] sm:w-[470px] sm:h-[470px] rounded-full bg-[#7028EF] opacity-95 right-2 top-8" />
            <div className="absolute w-[180px] h-[180px] rounded-full bg-[#B7FF00] right-0 bottom-4 blur-[2px]" />
            <div className="vp-visual-card relative w-full max-w-[500px] rounded-[2rem] p-5 sm:p-7 rotate-[1deg]">
              ...
              <div className="relative rounded-[1.5rem] bg-[#F7F0FF] p-5 sm:p-6 overflow-hidden min-h-[330px]">
                ...
                <div className="absolute left-5 top-8 bg-white rounded-2xl p-3 shadow-lg w-40 rotate-[-4deg]">
                ...
                <div className="absolute left-8 bottom-7 bg-white rounded-2xl p-3 shadow-lg w-44 rotate-[3deg]">
                ...
                <div className="absolute right-5 bottom-8 bg-white rounded-2xl p-3 shadow-lg w-40 rotate-[-3deg]">
      ...
      <div className="max-w-5xl mx-auto px-5 sm:px-8 -mt-10 sm:-mt-12 relative z-10">
      ...
      <section id="about" className="max-w-6xl mx-auto px-5 sm:px-8 py-20 sm:py-28">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <h2 className="section-title">One VIT. One community.</h2>
      ...
      <section id="why" className="bg-white border-y border-line">
        <div className="max-w-6xl mx-auto px-5 sm:px-8 py-20 sm:py-28">
          <div className="max-w-2xl">
            <span className="section-kicker">Why VITPEERS</span>
            <h2 className="section-title">More useful than another social feed.</h2>
      ...
      <section id="how" className="max-w-6xl mx-auto px-5 sm:px-8 py-20 sm:py-28">
        <div className="text-center max-w-2xl mx-auto">
          ...
          <h2 className="section-title">From “I need help” to “I know someone.”</h2>
        </div>
      ...
      <section id="journey" className="bg-paper">
        <div className="max-w-6xl mx-auto px-5 sm:px-8 py-20 sm:py-28 grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <h2 className="section-title">Different year. Different question. Same community.</h2>
      ...
      <section id="community" className="max-w-6xl mx-auto px-5 sm:px-8 py-20 sm:py-28">
        <div className="rounded-[2rem] bg-vm-gradient text-white p-8 sm:p-12 grid lg:grid-cols-2 gap-10 items-center overflow-hidden">
          <div>
            <span className="section-kicker text-white/60">The community</span>
            <h2 className="font-display text-3xl sm:text-4xl mt-2">Ask. Share. Help. Grow.</h2>
      ...
      <section className="bg-white border-t border-line">
        <div className="max-w-6xl mx-auto px-5 sm:px-8 py-20 text-center">
          ...
          <h2 className="font-display text-4xl sm:text-5xl text-navy mt-2">Your VIT network is bigger than your classroom.</h2>
